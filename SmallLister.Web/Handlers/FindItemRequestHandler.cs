...
namespace SmallLister.Web.Handlers
{
    ...
    {
        private readonly ILogger<FindItemRequestHandler> _logger;
        ...
        public async Task<FindItemResponse> Handle(FindItemRequest request, CancellationToken cancellationToken)
        {
            ...
            var items = string.IsNullOrWhiteSpace(request.SearchQuery) ? new List<UserItem>() : await _userItemRepository.FindItemsByQueryAsync(user, request.SearchQuery);
