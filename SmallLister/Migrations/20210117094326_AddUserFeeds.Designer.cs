...
namespace SmallLister.Migrations
{
    ...
    [Migration("20210117094326_AddUserFeeds")]
    partial class AddUserFeeds
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SmallLister.Model.UserFeedItem", b =>
                {
                    b.Property<int>("UserFeedItemId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("SmallLister.Model.UserFeedItem", b =>
                {
                    b.HasOne("SmallLister.Model.UserFeed", "UserFeed")
                        .WithMany()
